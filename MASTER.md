{
    ...
    "activeObjective": {
        ...
        "nextGateAskFirst": "STOCK CPU DONE 2715/14569 + COMPUTE DONE 194800 OpenCL. Need (1) peak summaries for cpu-stock-671.csv, gpu-stock-671-cpu.csv, gpu-stock-671-compute.csv, (2) Superposition 1080p Extreme run with dmon meter.",
