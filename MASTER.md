{
    ...
    "activeObjective": {
        ...
        "nextGateAskFirst": "STOCK BASELINE COMPLETE. Next = (1) commit final scoreboard, (2) operator gate: BIOS save STOCK-20260825 profile, set P 50x E 40x @1.28V, LLC medium, Speed Shift/C-states/EIST/HT on, AVX offset 0, save+exit, (3) re-run identical bench set (Geekbench CPU+Compute + Superposition 1080p Extreme) with same file-backed meters into oc-meters/*-bios1.*, (4) after BIOS stable, log out/in to make Coolbits live, then GWE step1 +60/+250 re-bench.",
