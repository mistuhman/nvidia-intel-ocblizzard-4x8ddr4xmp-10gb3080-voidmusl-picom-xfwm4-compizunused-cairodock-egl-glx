{
    ...
    "objective": {
        ...
        "liveGates": [
            ...
            "10. VALIDATE the 4000 MT/s @ 1.45 V custom profile (r3) before any further OC work - operator directive 2026-08-27 ('just rebooted, need to verify before we move on'): ram-validate full r3 (trained-speed + 1h stress + scrub nvme + dmesg clean), then 8 h daily use + second scrub; blocks the GPU/idle/CPU tracks until PASS"
        ],
        "unconfirmedHandoff": [
