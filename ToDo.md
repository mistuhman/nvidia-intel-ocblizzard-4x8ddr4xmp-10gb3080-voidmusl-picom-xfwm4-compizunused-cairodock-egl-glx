...
- [x] 1. **AirPort Base Station / Time Capsule Factory Reset**: Perform pinhole hard factory reset on the Time Capsules and AirPort Express so AirPort Utility can configure them cleanly without password prompts. (6.3.1 installed on Lion per operator 2026-09-15; resets DONE per operator 2026-09-16 - the LED line in that message (AP1 blink-green, AP2 amber, Express unresponsive) was the post-reset state report.)
