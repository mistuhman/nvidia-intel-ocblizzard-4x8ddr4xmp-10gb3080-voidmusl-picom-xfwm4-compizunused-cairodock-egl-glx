#!/usr/bin/env node
// Print the GitHub blob/raw URLs for local paths on the CURRENT branch of this repo's
// origin. Use for mirror pages, burn pages, and any operator-facing link: the link is
// derived from the live branch, never hand-typed.
