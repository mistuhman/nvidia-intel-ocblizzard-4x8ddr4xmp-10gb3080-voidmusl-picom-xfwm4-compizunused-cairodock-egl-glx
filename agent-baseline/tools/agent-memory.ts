...
// Purpose: reach 1:1 accuracy in how agents respond and perceive OVER making up discrepancies.
// Every claim an agent makes about the chat history or an image must trace to an entry here;
// `check` prints MISSING when nothing is recorded.
// The ledger stores stacks = named short-term windows grouping seqs. Agents disperse by pulling
