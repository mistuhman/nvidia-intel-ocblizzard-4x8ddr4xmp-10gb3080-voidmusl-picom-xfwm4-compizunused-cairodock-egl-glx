#!/usr/bin/env node
// Source receipt tool: fetch URLs (or read local files via file://), strip HTML to
// text, hash, clip, and optionally write one JSON per source into --out=.
// Deterministic per input bytes; status<200 or >299 exits 1.
