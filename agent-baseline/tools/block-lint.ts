#!/usr/bin/env node
// Console-safe block hygiene for the direct chat loop. --root requires the first
// non-empty line to be exactly "id -u". --target-console adds the strict paste rules
// for the web console (no <>&, no quotes, no chaining). Reads a file or stdin.
