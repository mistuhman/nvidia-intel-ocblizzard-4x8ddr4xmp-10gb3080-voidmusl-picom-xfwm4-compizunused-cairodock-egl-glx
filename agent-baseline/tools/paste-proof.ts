#!/usr/bin/env node
// Full paste proof: block hygiene + bash -n syntax + the file-gate warnings
// (df -h / before diagnosing rc=1, ls -l before trusting a created file).
// --sandbox-run executes the block in the sandbox after the checks pass.
